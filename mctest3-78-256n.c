...
/*
 * Compilación:
 * gcc -O3 -march=native -static mctest3-78-256n.c -o mctest3-78-256n.exe -lgmp
 * Uso:
 * ./mctest3-78-256n <n>
 * Ejemplo para n=0 (k=78):  ./mctest3-78-256n 0
 * Ejemplo para n=1 (k=334):  ./mctest3-78-256n 1
 */
...
int main(int argc, char *argv[]) {
    ...
    unsigned long k = 78 + 256 * n_input;
