...
/*
 * Compilación:
 * gcc -O3 -march=native -static mctest3-322-512n.c -o mctest3-322-512n.exe -lgmp
 * Uso:
 * ./mctest3-322-512n <n>
 * Ejemplo para n=0 (k=322):  ./mctest3-206-256n 0
 * Ejemplo para n=1 (k=834):  ./mctest3-206-256n 1
 */
...
int main(int argc, char *argv[]) {
    ...
    unsigned long k = 322 + 512 * n_input;
